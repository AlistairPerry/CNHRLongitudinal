...
#Set working data
setwd("/Users/alistairp/Documents/Brisbane/CNHRLongitudinal_dropbox/NBS_interaction/AddingBDS/Output/LMM")


#Load connectivity weights data

TenPercWeights <- read_excel("/Users/alistairp/Documents/Brisbane/CNHRLongitudinal_dropbox/NBS_interaction/Output/Interaction_EdgeWeights7.5_10_12.5%thresholdingWithoutAgeAsCovariate_Sub-groupData01.09.20.xlsx", sheet = 1, range = cell_rows(2:368))


#And full demographics to make life easier for me

Dems <- read.csv2("/Users/alistairp/Documents/Brisbane/CNHRLongitudinal_dropbox/Misc/alln183DEMS.txt", header = TRUE, sep = ",")
...
TenPercWeightsBD <- read_excel("/Users/alistairp/Documents/Brisbane/CNHRLongitudinal_dropbox/NBS_interaction/AddingBDS/Interaction_EdgeWeights7.5_10_12.5%25thresholdingWithoutAgeAsCovariate_Sub-groupData-IncludesBDsubjects_12.04.21_onlyn52BDs.xlsx", sheet = 1, range = cell_rows(370:422))
